...
// Classe responsável pelo cáculo do Fatorial do nùmero selecionado pelo usuário
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int n = Integer.parseInt(txtNum.getValue().toString()); // Captura o valor selecionado pelo usuário
        Fatorial f = new Fatorial(); // f referencia um objeto da classe Fatorial
        f.setValor(n); // Seta o valor selecionadao pelo usuário no objeto
        lblFormula.setText(f.getFormula()); // Insere a fómula de fatorial na tela
        lblResultado.setText(Integer.toString(f.getFatorial())); // Insere o resultado do fatorial na tela
